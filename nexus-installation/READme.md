...
```sh
sudo wget http://download.sonatype.com/nexus/3/nexus-3.58.0-01-unix.tar.gz 
sudo tar -zxvf nexus-3.58.0-01-unix.tar.gz
sudo mv /opt/nexus-3.58.0-01 /opt/nexus
sudo rm -rf nexus-3.58.0-01-unix.tar.gz
```
